...
write.csv(test_extract,file=paste0("DATAF2-m/",2015+ij,"-f2-m.csv"), row.names = FALSE)
if (ij==1) main_f2_1_m<-test_extract else main_f2_1_m<-rbind(main_f2_1_m,test_extract)

}

save (main_f2_1_m,file = "f2_1-m.RData")
