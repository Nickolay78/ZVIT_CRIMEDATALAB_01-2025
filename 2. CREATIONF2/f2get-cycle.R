...
special_pgo<-data.frame (
  ...
  http=c("https://old.gp.gov.ua/ua/stst2011.html?_m=fslib&_t=fsfile&_c=download&file_id=200947",
         ...
         "https://old.gp.gov.ua/ua/file_downloader.html?_m=fslib&_t=fsfile&_c=download&file_id=260046"
         ),
  Trange=c("A20:AE93",
           "A22:AF101",
           "A24:AF111",
...
}### Важлива умова для останніх років значення 9 відповідає 2024 року
