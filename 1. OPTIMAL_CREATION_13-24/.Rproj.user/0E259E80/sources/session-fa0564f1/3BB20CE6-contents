...
special_court<-data.frame (
  ...
  http=c("https://court.gov.ua/userfiles/6_2013.xls",
         ...
         "https://court.gov.ua/userfiles/media/new_folder_for_uploads/main_site/6_4-2023.xls",
         "https://court.gov.ua/userfiles/media/new_folder_for_uploads/main_site/6_4-2023.xls"),#2024 DSA DATA
  Trange=c("A14:BM889",
           "A14:BM909",
           "A14:BM962",
           "A14:BM965",
...
for (yr in ymin:ymax) 
{
if ((yr<2017)|(yr==2022)|(yr==2023)|(yr==2024)) {ext<-".xls"} else {ext<-".xlsx"}
