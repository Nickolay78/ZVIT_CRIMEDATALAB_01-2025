...
special_pgo<-data.frame (
  ...
  http=c("https://old.gp.gov.ua/ua/stst2011.html?_m=fslib&_t=fsfile&_c=download&file_id=185282",
         ...
         "https://old.gp.gov.ua/ua/file_downloader.html?_m=fslib&_t=fsfile&_c=download&file_id=241804",
         "https://old.gp.gov.ua/ua/file_downloader.html?_m=fslib&_t=fsfile&_c=download&file_id=260042"#OPG 2024
         ),
  Trange=c("A78:X770",
           "A78:X784",
           "A78:X786",
  ...
  TNames=c("Year Article Chapter ACC SUSP STPIL STPLOC STPFOR INDICM REL MED EDU RECID GROUP INTOX JUVEN CLOSE CL1.2 NODEC",
           ...
           "Year Article Chapter ACC SUSP STPIL STPLOC STPSDR STPFOR TOCRT INDICM REL MED EDU CL3.1 RECID GROUP INTOX JUVEN CLOSE CL1.2 CL10 NODEC",
           "Year Article Chapter ACC SUSP STPIL STPLOC STPSDR STPFOR TOCRT INDICM REL MED EDU CL3.1 RECID GROUP INTOX JUVEN CLOSE CL1.2 CL10 NODEC",
           "Year Article Chapter ACC SUSP STPTOT STPIL STPLOC STPFOR TOCRT INDICM REL MED EDU CL3.1 RECID GROUP INTOX JUVEN CLOSE CL1.2 CL10 NODEC",
           "Year Article Chapter ACC SUSP STPTOT STPIL STPLOC STPFOR TOCRT INDICM REL MED EDU CL3.1 RECID GROUP INTOX JUVEN CLOSE CL1.2 CL10 NODEC"),
  colTypes=c(
...
if (Year<2017) {pgo_y$STPSDR<-NA}
if (Year<2020) {pgo_y$TOCRT<-pgo_y$INDICM+pgo_y$REL+pgo_y$MED+pgo_y$EDU
                  pgo_y$CL3.1<-NA
                  pgo_y$CL10<-NA}
if (Year>2022) {pgo_y$STPSDR<-NA}
if (Year<2023) {pgo_y$STPTOT<-NA}
